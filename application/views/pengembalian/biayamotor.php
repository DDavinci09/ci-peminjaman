...
<div class="container-fluid">
    ...
    <br>
                <?php echo validation_errors(); ?>
                    <?php echo form_open_multipart('Pengembalian/tambahbiayaMotor/'. $pg['kd_pengembalian']); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Kode Ops Motor</label>
                                    <input type="text" class="form-control" id="kd_ops_motor" name="kd_ops_motor" value="<?= $autoKD; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
